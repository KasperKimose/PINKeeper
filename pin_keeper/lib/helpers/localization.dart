...
import 'package:pin_keeper/helpers/messages.dart';
...
class SampleLocalizations {
  ...
  static Future<SampleLocalizations> load(Locale locale) {
    return initializeMessages(locale.toString()).then((_) {
      return SampleLocalizations(locale);
    });
  }

  static SampleLocalizations of(BuildContext context) {
    return Localizations.of<SampleLocalizations>(
        context, SampleLocalizations);
  }
